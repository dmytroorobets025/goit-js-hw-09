...
const options = {
    ...
    onClose (selectedDates) {
        if (Date.now() > selectedDates[0]) return (0, _notiflixDefault.default).Notify.warning("Please choose a date in the future");
...
const startTimer = ()=>{
    ...
    const timerId = setInterval(()=>{
        ...
        if (timeToShow <= 0) {
            ...
            return (0, _notiflixDefault.default).Notify.success("Time is over!");
        }
